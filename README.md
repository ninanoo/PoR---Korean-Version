...
고정되는 앞 상수 비트들이 연속되는 0이 되도록 첫 블록을 발행하여 사이드체인으로의 가능성을 고려해 볼 수 있습니다.



이 알고리즘은 코인 발행을 목적으로 고안되지는 않았습니다.
그러나 보상 체계는 필요하고 이는 여타 스마트계약(smart contract) 관련 알고리즘들의 방법을 따릅니다.
