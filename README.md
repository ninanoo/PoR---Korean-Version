...
인증 정보가 들어있는 블록들은 인증이 확정된 블록과 가장 최근 생선된 확정되지 않은 하나의 블록으로 나누어집니다.
...
그러나 이는 적지 않은 시간이 소요되고 아직 확정되지 않은 정보가 추가되는 후보 블록들에 포함되어 서비스거부공격(denial of service attack)에 사용될 수도 있습니다.
